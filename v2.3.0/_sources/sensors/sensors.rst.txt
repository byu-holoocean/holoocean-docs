...
specific locations called "sockets" (see :ref:`sockets` for more information). Sensors publish data 
to the simulation state, which can be accessed as the return value of the environment's ``.tick()`` 
and ``.step()`` functions.
